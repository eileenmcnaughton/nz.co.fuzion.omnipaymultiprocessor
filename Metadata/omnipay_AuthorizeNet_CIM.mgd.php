<?php
/**
 * Created by Brian Zick <brian@zick.io>
 *
...
return array(
    array(
        ...
        'params' => array(
            ...
            'description' => 'Omnipay OmniPay - Authorize CIM Payment Processor',
            'user_name_label' => 'Api Login ID',
            'password_label' => 'Transaction Key',
            'signature_label' => 'Hash Secret',
            'class_name' => 'Payment_OmnipayMultiProcessor',
            'url_site_default' => 'https://api.authorize.net/xml/v1/request.api',
