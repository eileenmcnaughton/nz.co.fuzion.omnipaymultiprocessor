...
return array(
    array(
        'name' => 'OmniPay - Payment Express PxPost',
        'entity' => 'payment_processor_type',
        'params' => array(
            'version' => 3,
            'title' => 'OmniPay - Payment Express PxPost',
            'name' => 'omnipay_PaymentExpress_PxPost',
            'description' => 'Omnipay Payment Express PxPost Payment Processor',
