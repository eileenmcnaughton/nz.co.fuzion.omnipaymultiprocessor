...
return [
  [
    'name' => 'OmniPay - FirstAtlanticCommerce',
    ...
    'params' => [
      ...
      'name' => 'omnipay_FirstAtlanticCommerce',
      'description' => 'First Atlantic Commerce on site processor',
      // DO NOT CHANGE: Labels are used as Omnipay gateway properties.
      'user_name_label' => 'Merchant ID',
      'password_label' => 'Merchant Password',
      'signature_label' => 'Acquirer ID',
