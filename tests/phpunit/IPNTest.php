 ...
 * @group headless
 */
class IPNTest extends \PHPUnit_Framework_TestCase implements HeadlessInterface, HookInterface, TransactionalInterface {
   ...
   */
  public function testWellForphpmedVersion() {
